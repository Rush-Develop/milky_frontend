  ...
  return (
    <div className={styles.headprofile}>
      {props.id === undefined ? (
        <a
          id="login"
          href="https://discord.com/api/oauth2/authorize?client_id=1060823658832076830&redirect_uri=http%3A%2F%2Flocalhost%3A8080%2Fjoin&response_type=token&scope=identify"
